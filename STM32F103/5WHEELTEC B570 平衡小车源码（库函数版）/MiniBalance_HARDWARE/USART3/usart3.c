...
{	
	...
	{	  
  	...
  	uart_receive=USART_ReceiveData(USART3); 
		...
		if(uart_receive==0x10)  Flag_front=1,Flag_back=0,Flag_Left=0,Flag_Right=0;
		if(uart_receive==0x11)  Flag_Stop=1,Flag_front=0,Flag_back=0,Flag_Left=0,Flag_Right=0;
		if(uart_receive==0x12)  Flag_Stop=0,Flag_front=0,Flag_back=1,Flag_Left=0,Flag_Right=0;
